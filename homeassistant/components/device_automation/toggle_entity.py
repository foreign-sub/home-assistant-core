...
ACTION_SCHEMA = cv.DEVICE_ACTION_BASE_SCHEMA.extend({
    ...
    vol.In([CONF_TOGGLE, CONF_TURN_OFF, CONF_TURN_ON]),
})
...
TRIGGER_SCHEMA = TRIGGER_BASE_SCHEMA.extend({
    ...
    cv.entity_id,
    vol.Required(CONF_TYPE):
    vol.In([CONF_TURNED_OFF, CONF_TURNED_ON]),
    vol.Optional(CONF_FOR):
    cv.positive_time_period_dict,
})
...
def async_condition_from_config(config: ConfigType
...
async def _async_get_automations(hass: HomeAssistant, device_id: str,
