...
from .const import ATTR_OUTSIDE_TEMPERATURE
from .const import ATTR_STATE_OFF
from .const import ATTR_STATE_ON
from .const import ATTR_TARGET_TEMPERATURE
...
class DaikinClimate(ClimateDevice):
    ...
    async def _set(self, settings):
        ...
        for attr in [
                ATTR_TEMPERATURE, ATTR_FAN_MODE, ATTR_SWING_MODE,
                ATTR_HVAC_MODE
        ]:
    ...
    def preset_mode(self):
        ...
        if (self._api.device.represent(HA_ATTR_TO_DAIKIN[ATTR_PRESET_MODE])[1]
