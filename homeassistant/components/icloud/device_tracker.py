...
from .const import SERVICE_LOST_IPHONE
from .const import SERVICE_RESET_ACCOUNT
from .const import SERVICE_SET_INTERVAL
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(ATTR_ACCOUNTNAME):
    cv.slugify,
    vol.Optional(CONF_MAX_INTERVAL, default=30):
    cv.positive_int,
    vol.Optional(CONF_GPS_ACCURACY_THRESHOLD, default=1000):
    cv.positive_int,
})
