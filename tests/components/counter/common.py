...
from homeassistant.components.counter import SERVICE_DECREMENT
from homeassistant.components.counter import SERVICE_INCREMENT
from homeassistant.components.counter import SERVICE_RESET
