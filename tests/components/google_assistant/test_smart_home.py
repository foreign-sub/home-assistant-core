...
from homeassistant.components.google_assistant import const
from homeassistant.components.google_assistant import EVENT_COMMAND_RECEIVED
from homeassistant.components.google_assistant import EVENT_QUERY_RECEIVED
from homeassistant.components.google_assistant import EVENT_SYNC_RECEIVED
...
async def test_device_class_binary_sensor(hass, device_class, google_type):
    ...
    sensor = DemoBinarySensor("Demo Sensor",
                              state=False,
                              device_class=device_class)
    sensor.hass = hass
